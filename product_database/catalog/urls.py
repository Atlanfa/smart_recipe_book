...
urlpatterns = [
    ...
    url(r'^profile/(?P<pk>[-\w]+)/edit/$', views.edit_profile, name='edit'),
    ...
    url(r'^bnfs/$', views.BalancedNutritionFormulaListView.as_view(), name='bnfs'),
    ...
    url(r'^bnf/(?P<pk>[-\w]+)/renew-bnf/$', views.renew_balanced_nutrition_formula, name='renew-bnf'),
